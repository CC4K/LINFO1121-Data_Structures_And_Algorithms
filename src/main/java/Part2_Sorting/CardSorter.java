    ...
    public static void sort(LinkedListImpl list) {
        ...
        for (int iter = 0; iter < list.getSize() - 1; iter++) {
            ...
            for (int i = 0; i < list.getSize()-1-iter; i++) {
                if (list.getFirst() > list.getSecond()) { // move the smallest to the end
                    list.swap();
                }
                list.pop();
            }
            // 7, 8, 2, 22, 102, 1
            // 8, 2, 22, 102, 1, 7
            // 2, 8, 22, 102, 1, 7 // 8, 22, 102, 1, 7, 2
            // 22, 102, 1, 7, 2, 8
            // 102, 1, 7, 2, 8, 22
            // 1, 102, 7, 2, 8, 22 // 102, 7, 2, 8, 22, 1

            // 7, 2, 8, 22, 1, 102 // 2, 7, 8, 22, 1, 102 // 7, 8, 22, 1, 102, 2
            // 8, 22, 1, 102, 2, 7
            // 22, 1, 102, 2, 7, 8
            // 1, 22, 102, 2, 7, 8 // 22, 102, 2, 7, 8, 1
            System.out.println("iter = "+iter);
//            System.out.println(list);
            for (int i = 0; i <= iter; i++) { // we know the "iter" items are already sorted (invariant)
                list.pop();
            }
            // 7, 2, 8, 22, 1, 102
